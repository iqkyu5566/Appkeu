...
<html>
    <head>
        ...
        <title>App Pembukuan Perusahaan</title>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>template/plugins/fullcalendar/fullcalendar.print.css" media="print">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>IC KENDARI</b></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">Laode Muh. AMSAR</span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            Innovation Center - Web Developer
                                            <small>Kendari 2017</small>
                                        </p>
                                    </li>
                                    <!-- Menu Body -->
                                    <li class="user-body">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2017 <a href="http://almsaeedstudio.com">Innovation Center Kendari</a>.</strong> All rights reserved.
            </footer>
