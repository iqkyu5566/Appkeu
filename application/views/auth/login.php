...
<html>
    <head>
        ...
        <!-- Stylequ -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>template/cssqu/style.css">
    ...
    <body class="hold-transition bg-body">
        <div class="login-box">
            <div class="row">
                <div class="col-md-3">
                    <div class="logo-title">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/image/logo.png" >
                    </div><!-- /.login-logo -->
                </div>
                <div class="col-md-9">
                    <div class="login-logo">
                        <a href="<?php echo base_url(); ?>"><b>JANEETA</b> GROUP</a>
                    </div><!-- /.login-logo -->
                </div>
            </div>
