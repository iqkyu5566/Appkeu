    ...
    <div class='col-xs-12'>
      <div class='box'>
        <div class='box-header'>
          ...
          <h3 class='box-title'>REKANAN toni</h3>
          <div class='box box-primary'>
            <form action="<?php echo $action; ?>" method="post">
              <table class='table table-bordered'>
                <tr>
                  <td>Nama Rekanan <?php echo form_error('nama_rekanan') ?></td>
                ...
                <tr>
                  <td>Key Person <?php echo form_error('key_person') ?></td>
                ...
                <tr>
                  <td>No Rek <?php echo form_error('no_rek') ?></td>
                ...
                <tr>
                  <td colspan='2'><button type="submit" class="btn btn-primary"><?php echo $button ?></button>
                    <a href="<?php echo site_url('rekanan') ?>" class="btn btn-default">Cancel</a></td>
                </tr>
